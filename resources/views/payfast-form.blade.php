...
<center><h3>Redirecting..</h3></center>
    ...
    <form id='payfast_payment_form' name='payfast-payment-form' method='post' action="https://ipguat.apps.net.pk/Ecommerce/api/Transaction/PostTransaction">
     ...
     <input type="hidden" name="TOKEN" value="{{$token}}" /><br/>
      ...
      <input type="hidden" name="SUCCESS_URL" value="https://m.qafexpress.com/" /><br/>
    
      <input type="hidden" name="FAILURE_URL" value="https://m.qafexpress.com/404/" /><br/>
    
      <input type="hidden" name="CHECKOUT_URL" value="https://m.qafexpress.com/user/dashboard" /><br/>
    
      <input type="hidden" name="CUSTOMER_EMAIL_ADDRESS" value="hadibutt476@gmail.com" /><br />
    
    <input type="hidden" name="CUSTOMER_MOBILE_NO" value="03045260527" /><br />
    
      <input type="hidden" name="TXNAMT" value="1" /><br />
     ...
     <input type="hidden" name="TXNDESC" value="ItemPurchased from Cart" /><br />
